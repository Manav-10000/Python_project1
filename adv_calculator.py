# main python program
response=['Welcome to advanced calculator','My name is MANAV',
		'Thanks for making me better ','Sorry ,this is beyond my abilitys']
...
# Response to command
# printing - "Thanks for making me better" on exit
def end():
	print(response[2])
